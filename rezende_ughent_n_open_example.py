...
name = (os.path.abspath(os.path.dirname(os.sys.argv[0]))) + os.sep + 'n_open_model'

##-------------------------------------------------------------##
##        PARAMETERS
##-------------------------------------------------------------##

n_w = 8        # n-contact width width  [um]
n_ofs = 23.5        # n-contact offset  [um]
