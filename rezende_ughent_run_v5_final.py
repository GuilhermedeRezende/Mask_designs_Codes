...
name = (os.path.abspath(os.path.dirname(os.sys.argv[0]))) + os.sep + 'rezende_ughent_ribs_final'
...
## ------------------------------------------------------------------ ##
    ...
    waveguide2 = gdspy.Path(wg_w2, (0,0))
...
for ii in range(0,n,1):
    ...
    combined_cell.add(gdspy.CellReference(gratc,origin=(0,-ii*d)))
    combined_cell.add(gdspy.CellReference(gratc,origin=(2*wgx + 2*(taper_ii_l)+iii_v_l, wgy-ii*d ),rotation=180, x_reflection=True))
