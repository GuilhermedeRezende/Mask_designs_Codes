...
name = (os.path.abspath(os.path.dirname(os.sys.argv[0]))) + os.sep + 'rezende_ughent_ribs_interc'

##-------------------------------------------------------------##
##        PARAMETERS
##-------------------------------------------------------------##

wg_w = 0.45        # waveguide width  [um]

gap0 = 0.15           #initial gaps between wv and ring [um]
gap1 = 0.25           #final gaps between wv and ring [um]

r1 = 20           #outer ring radius [um]
...
d = 100           # space between devices                             [um]
